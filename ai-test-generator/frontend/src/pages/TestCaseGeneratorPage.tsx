...
// Hooks
import { useJira, useTestCases } from '../hooks';
...
const TestCaseGeneratorPage: React.FC = () => {
  ...
  const { findSimilarTestCases } = useTestCases();
  ...
  return (
    <Box>
      ...
      <Typography variant="body1" color="text.secondary" paragraph>
        Create comprehensive test cases using AI. Choose between Jira integration
        or manual input based on your workflow.
      </Typography>
                  ...
                  <Box sx={{ display: 'flex', gap: 2, justifyContent: 'flex-end' }}>
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        enqueueSnackbar('Navigate to review page', { variant: 'info' });
                      }}
                    >
                      Review & Edit
                    </Button>
                ...
                <Card>
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary" paragraph>
                      These existing test cases might be relevant to your current requirements.
                    </Typography>
